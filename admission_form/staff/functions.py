from admission_form.models import Admission, PaymentScreenshot, FollowUp, ActivityLog, FeePayment, Reference
...
def student_applications_list(request,status=None):
    try:
        ...
        # Advanced Filters
        admission_status_filter = request.GET.get('admission_status', '')
        if admission_status_filter:
            queryset = queryset.filter(admission_status=admission_status_filter)
        ...
        context = {
            ...
            'sort_by': sort_by,
            # new filters
            'admission_status_filter': admission_status_filter,
        ...
        return redirect('admission_form:home')
...
def admission_report(request, pk):
    try:
        ...
        return redirect('admission_form:student_detail', pk=pk)
